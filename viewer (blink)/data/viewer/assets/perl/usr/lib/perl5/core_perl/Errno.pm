...
"x86_64-linux-thread-multi-5.15.108-0-lts" or
	die "Errno architecture (x86_64-linux-thread-multi-5.15.108-0-lts) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
